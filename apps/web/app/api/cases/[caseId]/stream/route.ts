  ...
  try {
    ...
    sendEvent({
      ...
      stats: {
        ...
        baselineLlmCost: baselineRun.llmCost,
        wgLlmCost: wgRun.llmCost,
        baselineToolCost: baselineRun.toolCost,
        wgToolCost: wgRun.toolCost,
        ...
        savingsPct: baselineRun.llmCost > 0 ? ((baselineRun.llmCost - wgRun.llmCost) / baselineRun.llmCost) * 100 : 0,
        budget,
